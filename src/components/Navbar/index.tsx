 ...
 * 
 * Menyediakan navigasi utama yang responsif, termasuk:
 * - Efek perubahan warna latar belakang saat halaman discroll.
 * - Form pencarian film yang mengarahkan ke halaman hasil pencarian.
 * - Avatar pengguna.
 * - Menu hamburger untuk tampilan mobile.
 * 
 * @returns Elemen JSX untuk navbar aplikasi.
 */
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center">
            <span className="text-red-600 text-2xl font-bold">GENFLIX</span>
          </Link>
